package interfaces.panels
{
   ...
   public class RatePanel extends Sprite
   {
      ...
      public var rateTextPanel:RateTextPanel;
      ...
      {
         this.rateTextPanel.CONTINUE_FLAG = true;
      }
      ...
      public function destroy() : void
      {
         ...
         this.title.dispose();
         this.title = null;
         removeChild(this.rateTextPanel);
         this.rateTextPanel.destroy();
         this.rateTextPanel.dispose();
         this.rateTextPanel = null;
      ...
      public function popUp() : void
      {
         ...
         this.rateTextPanel.visible = true;
         this.rateTextPanel.resetValues();
         this.rateTextPanel.alpha = 0;
         tween = new Tween(this.rateTextPanel,0.25,Transitions.EASE_OUT);
         tween.fadeTo(1);
         Starling.juggler.add(tween);
      ...
      public function popOut() : void
      {
         ...
         tween.fadeTo(0);
         Starling.juggler.add(tween);
         tween = new Tween(this.rateTextPanel,0.15);
         tween.fadeTo(0);
         Starling.juggler.add(tween);
      ...
      protected function evaluatePercentages() : void
      {
         ...
         this.outer_x_margin = this.outer_y_margin = int((WIDTH - this.body_width) * 0.5);
      ...
      {
         this.title = new TextPanel(StringsManager.GetString("rate_android_3"),this.body_width,26);
         this.title.fit();
      ...
      {
         this.rateTextPanel = new RateTextPanel(this.body_width,this.body_height - (this.inner_margin + 26));
         this.rateTextPanel.x = this.outer_x_margin;
         this.rateTextPanel.y = this.outer_y_margin + 26 + this.inner_margin;
         addChild(this.rateTextPanel);
      }
