package interfaces.panels
{
   ...
   public class DoubleCoinsPanel extends Sprite
   {
      
      public static var rewardedVideoAd:RewardedVideoAd = null;
      ...
      protected var REWARD_COMPLETED:Boolean;
      
      protected var REWARD_JUST_ONCE:Boolean;
      
      protected var CLOSED_ALREADY:Boolean;
      ...
      public function DoubleCoinsPanel(type:int = 0)
      {
         super();
         ...
         this.REWARD_COMPLETED = false;
         this.REWARD_JUST_ONCE = true;
         this.CLOSED_ALREADY = false;
         ...
         if(Adverts.service.rewardedVideoAds.isSupported)
         {
            if(!IsRewardAdAvailable())
            {
               ...
               rewardedVideoAd.setAdUnitId("ca-app-pub-6892794320149398/2094555266");
            }
            rewardedVideoAd.addEventListener(FullScreenContentEvent.SHOW,this.openedHandler);
            rewardedVideoAd.addEventListener(FullScreenContentEvent.DISMISSED,this.closedHandler);
            rewardedVideoAd.addEventListener(RewardedVideoAdEvent.REWARD,this.rewardHandler);
            if(!IsRewardAdAvailable())
            {
               this.preloadReward();
            }
      ...
      public static function IsRewardAdAvailable() : Boolean
      {
         if(Adverts.service.rewardedVideoAds.isSupported)
         {
      ...
      public function destroy() : void
      {
         ...
         if(Adverts.service.rewardedVideoAds.isSupported)
         {
            if(rewardedVideoAd != null)
            {
               rewardedVideoAd.removeEventListener(FullScreenContentEvent.SHOW,this.openedHandler);
               rewardedVideoAd.removeEventListener(FullScreenContentEvent.DISMISSED,this.closedHandler);
               rewardedVideoAd.removeEventListener(RewardedVideoAdEvent.REWARD,this.rewardHandler);
            }
         }
         if(this.visible)
         {
      ...
      public function continuePanel() : void
      {
         ...
         else if(Adverts.service.rewardedVideoAds.isSupported)
         {
      ...
      {
         if(this.REWARD_JUST_ONCE)
         {
            this.REWARD_JUST_ONCE = false;
         }
      ...
      protected function initButtons() : void
      {
         ...
         this.continueButton = new BalloonButton(BalloonButton.TYPE_DOUBLE_COINS);
      ...
      public function preloadReward() : void
      {
      ...
      internal function rewardHandler(event:RewardedVideoAdEvent) : void
      {
         this.videoRewardComplete();
      }
   }
