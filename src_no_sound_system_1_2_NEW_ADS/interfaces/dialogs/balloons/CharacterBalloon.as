package interfaces.dialogs.balloons
{
   ...
   public class CharacterBalloon extends Balloon
   {
      ...
      public function CharacterBalloon(_dialog:Dialog, _width:int, _height:int)
      {
      ...
      protected function createBalloon() : void
      {
         ...
         this._arrow = new Image(TextureManager.hudTextureAtlas.getTexture("dialog_arrow"));
         this._arrow.pivotX = 3;
         this._arrow.x = int(WIDTH * 0.5);
      ...
      protected function adaptToArea() : void
      {
         ...
         var origin_y:int = int(Math.floor(HEIGHT - __height));
      ...
      override public function setOffset(amount:int) : void
      {
         ...
         this._arrow.x = int(WIDTH * 0.5 + this.offset.x);
         this.adaptToArea();
      }
   }
}
