package levels.backgrounds.elements
{
   ...
   public class NightFlagBackgroundElement extends BackgroundElement
   {
      
      protected var sprite:GameSprite;
      
      public function NightFlagBackgroundElement(_level:Level, _x:Number, _y:Number, _name:String, _container:Sprite)
      {
         super(_level,_x,_y,_name,_container);
         this.sprite = new NightFlagBackgroundSprite();
