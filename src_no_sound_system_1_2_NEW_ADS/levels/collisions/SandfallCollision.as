package levels.collisions
{
   ...
   public class SandfallCollision extends Collision
   {
      ...
      public function SandfallCollision(_level:Level, _xPos:Number, _yPos:Number, _width:Number, _height:Number)
      {
         ...
         COLLISION_ID = SandfallCollision.SANDFALL_PLATFORM_COLLISION_ID++;
      ...
      override public function update() : void
      {
         ...
         if(this.particle_counter++ > 0)
         {
            ...
            level.particlesManager.createSandParticles(xPos + Math.random() * WIDTH,yPos + HEIGHT);
         }
      }
      ...
      protected function initWaves() : void
      {
         ...
         for(i = 0; i < amount; i++)
         {
            wSprite = new SandfallWaveCollisionSprite();
      ...
      protected function initSprites() : void
      {
         ...
         this.middleCenter = new SandfallCollisionSprite();
