package levels.scripts
{
   ...
   public class CollisionsScriptsManager
   {
      ...
      public static function CheckCollisionsScripts(map:XML, array:Array) : void
      {
         var obj:XML = null;
         var gScript:GenericScript = null;
         for each(obj in map.collisions[0].obj)
         {
      ...
      public function CollisionsScriptManager() : void
      {
      }
   }
}
