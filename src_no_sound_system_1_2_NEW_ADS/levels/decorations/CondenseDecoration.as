package levels.decorations
{
   ...
   import levels.Level;
   import sprites.decorations.CondenseDecorationSprite;
   ...
   public class CondenseDecoration extends Decoration
   {
      ...
      protected var IS_ACID:Boolean;
      
      public function CondenseDecoration(_level:Level, _xPos:Number, _yPos:Number, _type:int)
      {
         super(_level,_xPos,_yPos);
         sprite = new CondenseDecorationSprite();
      ...
      override public function update() : void
      {
         ...
         else if(this.stateMachine.currentState == "IS_TENSION_STATE")
         {
            if(sprite.gfxHandleClip().isComplete)
            {
               level.particlesManager.pushParticle(new DewParticleSprite(),xPos + 8,yPos + 4,0,0,1);
               this.stateMachine.performAction("END_ACTION");
            }
         }
      }
      ...
      protected function notFormedState() : void
      {
         ...
         this.counter1 = int((Math.random() * 10 + 2) * 30);
      }
