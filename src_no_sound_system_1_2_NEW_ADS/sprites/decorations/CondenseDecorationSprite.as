package sprites.decorations
{
   ...
   public class CondenseDecorationSprite extends GameSprite
   {
      ...
      public function CondenseDecorationSprite()
      {
         super();
         this.initAnims();
         this.initAnims2();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("condenseFormingDecorationSpriteAnim_"),12);
      ...
      {
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("condenseDrippingDecorationSpriteAnim_a"),12);
