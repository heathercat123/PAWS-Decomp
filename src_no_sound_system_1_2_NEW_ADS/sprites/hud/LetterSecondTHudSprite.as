package sprites.hud
{
   ...
   public class LetterSecondTHudSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function LetterSecondTHudSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("secondTLetterSpriteAnim_"),12);
