package sprites.hud
{
   ...
   public class SmallCatHudSprite extends GameSprite
   {
      ...
      public function SmallCatHudSprite()
      {
         super();
         this.initAnim1();
         this.initAnim3();
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("smallCatItemHudSpriteHiddenAnim_a"),12);
      ...
      {
         this.anim3 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("smallCatItemHudSpriteGetAnim_"),12);
      ...
      {
         this.anim4 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("smallCatItemHudSpriteVisibleAnim_a"),12);
