package sprites.hud
{
   ...
   public class LetterFirstSHudSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function LetterFirstSHudSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("firstSLetterSpriteAnim_"),12);
