package sprites.hud
{
   ...
   public class LetterFirstLHudSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function LetterFirstLHudSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("firstLLetterSpriteAnim_"),12);
