package sprites.hud
{
   ...
   public class LetterFirstAHudSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function LetterFirstAHudSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("firstALetterSpriteAnim_"),12);
