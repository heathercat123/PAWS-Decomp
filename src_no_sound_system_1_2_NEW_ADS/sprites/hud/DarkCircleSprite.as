package sprites.hud
{
   ...
   public class DarkCircleSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function DarkCircleSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("darkCircleSpriteAnim_"),12);
