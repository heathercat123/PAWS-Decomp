package sprites.hud
{
   ...
   public class LetterSecondAHudSprite extends GameSprite
   {
      
      protected var anim1:GameMovieClip;
      
      public function LetterSecondAHudSprite()
      {
         super();
         this.initAnim1();
         addChild(this.anim1);
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("secondALetterSpriteAnim_"),12);
