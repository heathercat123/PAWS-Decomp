package sprites.hud
{
   ...
   public class BellItemHudSprite extends GameSprite
   {
      ...
      public function BellItemHudSprite()
      {
         super();
         this.initAnim1();
         this.initAnim3();
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bellItemHudSpriteHiddenAnim_a"),12);
      ...
      {
         this.anim3 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bellItemHudSpriteGetAnim_"),12);
      ...
      {
         this.anim4 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bellItemHudSpriteVisibleAnim_a"),12);
