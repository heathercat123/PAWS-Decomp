package sprites.hud
{
   ...
   public class BigCatHudSprite extends GameSprite
   {
      ...
      public function BigCatHudSprite()
      {
         super();
         this.initAnim1();
         this.initAnim3();
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bigCatItemHudSpriteHiddenAnim_a"),12);
      ...
      {
         this.anim3 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bigCatItemHudSpriteGetAnim_"),12);
      ...
      {
         this.anim4 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("bigCatItemHudSpriteVisibleAnim_a"),12);
