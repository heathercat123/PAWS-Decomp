package sprites.hud
{
   ...
   public class KeyItemHudSprite extends GameSprite
   {
      ...
      public function KeyItemHudSprite()
      {
         super();
         this.initAnim1();
         this.initAnim3();
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("keyItemHudSpriteHiddenAnim_a"),12);
      ...
      {
         this.anim3 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("keyItemHudSpriteGetAnim_"),12);
      ...
      {
         this.anim4 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("keyItemHudSpriteVisibleAnim_a"),12);
