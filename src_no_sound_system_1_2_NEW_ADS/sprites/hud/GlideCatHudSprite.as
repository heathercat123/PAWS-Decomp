package sprites.hud
{
   ...
   public class GlideCatHudSprite extends GameSprite
   {
      ...
      public function GlideCatHudSprite()
      {
         super();
         this.initAnim1();
         this.initAnim3();
      ...
      {
         this.anim1 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("glideCatItemHudSpriteHiddenAnim_a"),12);
      ...
      {
         this.anim3 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("glideCatItemHudSpriteGetAnim_"),12);
      ...
      {
         this.anim4 = new GameMovieClip(TextureManager.hudTextureAtlas.getTextures("glideCatItemHudSpriteVisibleAnim_a"),12);
