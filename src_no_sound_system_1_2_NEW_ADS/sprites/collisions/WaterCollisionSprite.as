package sprites.collisions
{
   ...
   public class WaterCollisionSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function WaterCollisionSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("waterCollisionSpriteAnim_"));
