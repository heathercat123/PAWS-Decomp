package sprites.collisions
{
   ...
   public class ConvoyBeltCollisionSprite extends GameSprite
   {
      ...
      public function ConvoyBeltCollisionSprite()
      {
         super();
         this.initAnims1();
         this.initAnims2();
      ...
      {
         var i:int = 0;
         this.standAnimation1 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("convoyBeltEndCollisionSpriteAnim_"),12);
         for(i = 0; i < this.standAnimation1.numFrames; i++)
         {
            this.standAnimation1.setFrameDuration(i,0.1);
         }
      ...
      {
         var i:int = 0;
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("convoyBeltMiddleCollisionSpriteAnim_"),12);
         for(i = 0; i < this.standAnimation2.numFrames; i++)
         {
            this.standAnimation2.setFrameDuration(i,0.1);
         }
