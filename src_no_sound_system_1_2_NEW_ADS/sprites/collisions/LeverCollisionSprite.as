package sprites.collisions
{
   ...
   public class LeverCollisionSprite extends GameSprite
   {
      ...
      public function LeverCollisionSprite()
      {
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("leverCollisionLeftAnim_"),12);
      ...
      {
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("leverCollisionRightAnim_"),12);
