package sprites.collisions
{
   ...
   public class SandfallCollisionSprite extends GameSprite
   {
      ...
      public function SandfallCollisionSprite()
      {
         super();
         this.initAnims1();
         this.initAnims2();
      ...
      {
         this.standAnimation1 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandfallCollisiontopSideSpriteAnim_"),12);
      ...
      {
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandfallCollisiontopCenterSpriteAnim_"),12);
      ...
      {
         this.standAnimation3 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandfallCollisionmiddleSideSpriteAnim_"),12);
      ...
      {
         this.standAnimation4 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandfallCollisionmiddleCenterSpriteAnim_"),12);
