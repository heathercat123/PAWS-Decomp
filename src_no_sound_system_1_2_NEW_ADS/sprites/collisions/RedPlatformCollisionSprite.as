package sprites.collisions
{
   ...
   public class RedPlatformCollisionSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function RedPlatformCollisionSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("redPlatformCollisionSpriteAnim_"),12);
