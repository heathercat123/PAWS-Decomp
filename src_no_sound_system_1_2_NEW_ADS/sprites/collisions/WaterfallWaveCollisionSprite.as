package sprites.collisions
{
   ...
   public class WaterfallWaveCollisionSprite extends GameSprite
   {
      
      protected var standAnimation1:GameMovieClip;
      
      public function WaterfallWaveCollisionSprite()
      {
         super();
         this.initAnims1();
      ...
      {
         var i:int = 0;
         this.standAnimation1 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("waterfallLargeWaveCollisionSpriteAnim_"),12);
