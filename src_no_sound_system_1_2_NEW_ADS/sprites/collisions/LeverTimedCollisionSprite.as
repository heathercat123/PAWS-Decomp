package sprites.collisions
{
   ...
   public class LeverTimedCollisionSprite extends GameSprite
   {
      ...
      public function LeverTimedCollisionSprite()
      {
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("leverTimedCollisionLeftAnim_"),12);
         this.standAnimation.setFrameDuration(0,0.01);
         this.standAnimation.setFrameDuration(1,0.1);
         this.standAnimation.setFrameDuration(2,0.01);
      ...
      {
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("leverTimedCollisionRightAnim_"),12);
         this.standAnimation2.setFrameDuration(0,0.01);
         this.standAnimation2.setFrameDuration(1,0.1);
         this.standAnimation2.setFrameDuration(2,0.01);
