package sprites.particles
{
   ...
   public class BubbleItemBurstParticleSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function BubbleItemBurstParticleSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("bubbleItemSpriteBurstAnim_"),12);
