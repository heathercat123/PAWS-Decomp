package sprites.particles
{
   ...
   public class FireSmallExplosionParticleSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function FireSmallExplosionParticleSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("fireSmallExplosionParticleSpriteAnim_"));
