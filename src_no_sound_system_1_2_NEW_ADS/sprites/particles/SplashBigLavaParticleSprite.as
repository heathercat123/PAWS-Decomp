package sprites.particles
{
   ...
   public class SplashBigLavaParticleSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function SplashBigLavaParticleSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("splashBigLavaParticleSpriteAnim_"));
         ...
         this.standAnimation.x = -18;
         this.standAnimation.y = -40;
