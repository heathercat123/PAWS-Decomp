package sprites.particles
{
   ...
   public class FreezeParticleSprite extends GameSprite
   {
      ...
      public function FreezeParticleSprite()
      {
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("FreezeParticleBigSpriteAnim_"),12);
         ...
         this.standAnimation2 = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("FreezeParticleSmallSpriteAnim_"),12);
