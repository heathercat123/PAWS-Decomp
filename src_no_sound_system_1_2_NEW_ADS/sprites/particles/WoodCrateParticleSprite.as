package sprites.particles
{
   ...
   public class WoodCrateParticleSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function WoodCrateParticleSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodParticleSpriteAnim_"));
