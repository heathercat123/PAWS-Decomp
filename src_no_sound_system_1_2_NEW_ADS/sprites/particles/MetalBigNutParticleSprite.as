package sprites.particles
{
   ...
   public class MetalBigNutParticleSprite extends GameSprite
   {
      
      protected var standAnimation:GameMovieClip;
      
      public function MetalBigNutParticleSprite()
      {
         super();
         this.initAnims();
      ...
      {
         this.standAnimation = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("metalBigNutParticleSpriteAnim_"));
