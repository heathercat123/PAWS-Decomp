package sprites.enemies
{
   ...
   public class TinSoldierEnemySprite extends GameSprite
   {
      ...
      public function TinSoldierEnemySprite()
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tinSoldierStandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tinSoldierTurnAnim_"));
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tinSoldierWalkAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tinSoldierHurtAnim_"));
