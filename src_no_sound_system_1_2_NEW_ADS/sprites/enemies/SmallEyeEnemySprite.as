package sprites.enemies
{
   ...
   public class SmallEyeEnemySprite extends GameSprite
   {
      ...
      public function SmallEyeEnemySprite()
      {
      ...
      {
         this.openAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeSmallEyeSpriteAnim_"));
      ...
      {
         this.normalAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeSmallEyeSpriteAnim_d"));
      ...
      {
         this.blinkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeSmallEyeBlinkSpriteAnim_"));
      ...
      {
         this.deadAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeSmallEyeDeadSpriteAnim_"));
