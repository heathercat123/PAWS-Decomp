package sprites.enemies
{
   ...
   public class MediumEyeEnemySprite extends GameSprite
   {
      ...
      public function MediumEyeEnemySprite()
      {
      ...
      {
         this.openAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeMediumEyeSpriteAnim_"));
      ...
      {
         this.normalAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeMediumEyeSpriteAnim_d"));
      ...
      {
         this.blinkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeMediumEyeBlinkSpriteAnim_"));
      ...
      {
         this.deadAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("giantEyeMediumEyeDeadSpriteAnim_"));
