package sprites.enemies
{
   ...
   public class FlameJumperEnemySprite extends GameSprite
   {
      ...
      public function FlameJumperEnemySprite()
      {
      ...
      {
         this.swimAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("fireJumperFlameEnemySwimAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("fireJumperFlameEnemyTurnAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("fireJumperFlameEnemyHurtAnim_"));
      ...
      {
         this.jumpAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("fireJumperFlameEnemyJumpAnim_"));
