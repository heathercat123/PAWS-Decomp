package sprites.enemies
{
   ...
   public class SeedPollenEnemySprite extends GameSprite
   {
      ...
      public function SeedPollenEnemySprite()
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("pollenEnemyStandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("pollenEnemyTurnAnim_"));
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("pollenEnemyWalkAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("pollenEnemyHurtAnim_"));
