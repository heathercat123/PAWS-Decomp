package sprites.enemies
{
   ...
   public class WoodBeetleEnemySprite extends GameSprite
   {
      ...
      public function WoodBeetleEnemySprite()
      {
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyWalkAnim_"),16);
      ...
      {
         this.rotateAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyRotateAnim_"),16);
      ...
      {
         this.rotateFrontAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyRotateFrontAnim_"),16);
      ...
      {
         this.hitAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyHitAnim_"),16);
      ...
      {
         this.hideAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyHideAnim_"),16);
      ...
      {
         this.unhideAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("woodBeetleEnemyUnhideAnim_"),16);
