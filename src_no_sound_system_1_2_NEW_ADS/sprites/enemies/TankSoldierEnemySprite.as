package sprites.enemies
{
   ...
   public class TankSoldierEnemySprite extends GameSprite
   {
      ...
      public function TankSoldierEnemySprite()
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tankSoldierStandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tankSoldierTurnAnim_"));
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tankSoldierWalkAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("tankSoldierHurtAnim_"));
