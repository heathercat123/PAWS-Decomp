package sprites.enemies
{
   ...
   public class SeaJumperFishEnemySprite extends GameSprite
   {
      ...
      public function SeaJumperFishEnemySprite()
      {
      ...
      {
         this.swimAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seaJumperFishEnemySwimAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seaJumperFishEnemyTurnAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seaJumperFishEnemyHitAnim_"));
      ...
      {
         this.jumpAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seaJumperFishEnemyJumpAnim_"));
