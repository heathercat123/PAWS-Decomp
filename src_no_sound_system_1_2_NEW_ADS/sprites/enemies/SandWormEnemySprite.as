package sprites.enemies
{
   ...
   public class SandWormEnemySprite extends GameSprite
   {
      ...
      public function SandWormEnemySprite()
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyStandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyTurnAnim_"));
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyWalkAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyHurtAnim_"));
      ...
      {
         this.hiddenAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyHiddenAnim_"));
      ...
      {
         this.unhideAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("sandWormEnemyUnhideAnim_"));
