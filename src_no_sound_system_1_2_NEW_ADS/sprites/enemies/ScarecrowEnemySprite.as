package sprites.enemies
{
   ...
   public class ScarecrowEnemySprite extends GameSprite
   {
      ...
      public function ScarecrowEnemySprite()
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("scarecrowStandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("scarecrowTurnAnim_"));
      ...
      {
         this.jumpAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("scarecrowJumpAnim_"));
         ...
         this.jumpAnim.setFrameDuration(4,0.1);
         this.jumpAnim.setFrameDuration(5,0.1);
      ...
      {
         this.groundAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("scarecrowGroundAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("scarecrowHurtAnim_"));
