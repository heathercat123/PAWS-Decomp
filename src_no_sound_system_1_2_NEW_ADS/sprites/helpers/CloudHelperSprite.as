package sprites.helpers
{
   ...
   public class CloudHelperSprite extends GameSprite
   {
      ...
      public function CloudHelperSprite(_level:int = 1)
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("cloudHelper" + this.LEVEL + "StandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("cloudHelper" + this.LEVEL + "TurnAnim_"));
      ...
      {
         this.attackAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("cloudHelper" + this.LEVEL + "AttackAnim_"));
