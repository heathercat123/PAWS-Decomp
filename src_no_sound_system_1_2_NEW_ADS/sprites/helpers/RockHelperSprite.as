package sprites.helpers
{
   ...
   public class RockHelperSprite extends GameSprite
   {
      ...
      public function RockHelperSprite(_level:int = 1)
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("rockHelper" + this.LEVEL + "StandAnim_"));
         if(this.LEVEL >= 2)
         {
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("rockHelper" + this.LEVEL + "TurnAnim_"));
      ...
      {
         this.attackAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("rockHelper" + this.LEVEL + "AttackAnim_"));
