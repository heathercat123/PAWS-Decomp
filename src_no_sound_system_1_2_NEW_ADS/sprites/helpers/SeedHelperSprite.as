package sprites.helpers
{
   ...
   public class SeedHelperSprite extends GameSprite
   {
      ...
      public function SeedHelperSprite(_level:int = 1)
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seedHelper" + this.LEVEL + "StandAnim_"));
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seedHelper" + this.LEVEL + "TurnAnim_"));
      ...
      {
         this.attackAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("seedHelper" + this.LEVEL + "AttackAnim_"));
