package sprites.helpers
{
   ...
   public class JellyfishHelperSprite extends GameSprite
   {
      ...
      public function JellyfishHelperSprite(_level:int = 1)
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("jellyfishHelper" + this.LEVEL + "StandAnim_"));
         if(this.LEVEL == 1)
         {
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("jellyfishHelper" + this.LEVEL + "TurnAnim_"));
      ...
      {
         this.attackAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("jellyfishHelper" + this.LEVEL + "AttackAnim_a"));
