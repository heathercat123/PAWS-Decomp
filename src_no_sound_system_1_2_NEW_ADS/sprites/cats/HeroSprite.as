package sprites.cats
{
   ...
   public class HeroSprite extends CatSprite
   {
      ...
      public function HeroSprite(_forced_cat_id:int = -1)
      {
      ...
      {
         this.standAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroStandAnim_"));
      ...
      {
         this.walkAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroWalkAnim_"),16);
      ...
      {
         this.turnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroTurnAnim_"),12);
      ...
      {
         this.jumpAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroJumpAnim_"));
      ...
      {
         this.fallAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroFallAnim_"));
      ...
      {
         this.climbAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroClimbAnim_"),20);
      ...
      {
         this.slideAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroSlideAnim_"));
      ...
      {
         this.runAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroRunAnim_"));
      ...
      {
         this.brakeAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroBrakeAnim_"));
      ...
      {
         this.hopAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroHopAnim_"));
      ...
      {
         this.fallRunAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroFallRunAnim_"));
      ...
      {
         this.hurtAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroHurtAnim_"));
      ...
      {
         this.levelStartAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroLevelStartAnim_"));
      ...
      {
         this.levelCompleteAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroLevelCompleteAnim_"));
         this.levelCompleteAnim.setFrameDuration(0,0.075);
         this.levelCompleteAnim.setFrameDuration(1,0.075);
         this.levelCompleteAnim.setFrameDuration(2,0.075);
         this.levelCompleteAnim.setFrameDuration(3,0.075);
         this.levelCompleteAnim.setFrameDuration(4,0.075);
         this.levelCompleteAnim.setFrameDuration(5,0.075);
         this.levelCompleteAnim.setFrameDuration(6,0.25);
         this.levelCompleteAnim.setFrameDuration(7,0.075);
      ...
      {
         this.swimAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroSwimAnim_"));
      ...
      {
         this.backAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroBackAnim_"));
      ...
      {
         this.ropeHangAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroRopeHangingAnim_"));
      ...
      {
         this.ropeTurnAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroRopeTurnAnim_"),12);
      ...
      {
         this.lookUpAnim = new GameMovieClip(TextureManager.sTextureAtlas.getTextures("heroLookUpAnim_"),12);
      ...
      override public function playSpecialAnim(type:int = 0) : void
      {
         ...
         else if(type == CatSprite.ALERT)
         {
            gfxHandle().gotoAndStop(18);
         }
      }
      ...
      override protected function initHatArray() : void
      {
         ...
         hat_frames[1].push(new FrameData(5,-6,1,6));
         hat_frames[1].push(new FrameData(5,-4,1,6));
         hat_frames[1].push(new FrameData(5,0,1,6));
         ...
         hat_frames[12].push(new FrameData(5,-2,1,6));
         hat_frames[12].push(new FrameData(5,-2,1,6));
         hat_frames[13].push(new FrameData(4,0,1,8));
         hat_frames[13].push(new FrameData(4,0,1,8));
         hat_frames[13].push(new FrameData(4,0,1,8));
         hat_frames[13].push(new FrameData(4,0,1,8));
         hat_frames[13].push(new FrameData(4,0,1,8));
         ...
         hat_frames[18].push(new FrameData(5,-2,3,6));
         hat_frames[18].push(new FrameData(5,-2,3,6));
         hat_frames[18].push(new FrameData(5,-2,3,6));
         hat_frames[18].push(new FrameData(5,-2,3,6));
