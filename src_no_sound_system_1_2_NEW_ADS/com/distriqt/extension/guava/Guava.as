package com.distriqt.extension.guava
{
   ...
   public final class Guava extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "com.google.guava";
      
      private static const EXT_ID_NUMBER:int = -1;
      
      public static const VERSION:String = "31.0.101";
      ...
      private static var _instance:Guava;
      ...
      public function Guava()
      {
         super();
         if(_shouldCreateInstance)
         {
            _extensionId = "com.google.guava";
      ...
      public static function get instance() : Guava
      {
         createInstance();
         return _instance;
      }
      
      public static function get service() : Guava
      {
         createInstance();
         return _instance;
      }
