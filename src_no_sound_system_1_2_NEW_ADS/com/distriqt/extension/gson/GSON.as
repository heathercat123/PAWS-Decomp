package com.distriqt.extension.gson
{
   ...
   public final class GSON extends EventDispatcher
   {
      
      public static const EXT_CONTEXT_ID:String = "com.google.code.gson";
      
      private static const EXT_ID_NUMBER:int = -1;
      
      public static const VERSION:String = "2.8.601";
      ...
      private static var _instance:GSON;
      ...
      public function GSON()
      {
         super();
         if(_shouldCreateInstance)
         {
            _extensionId = "com.google.code.gson";
      ...
      public static function get instance() : GSON
      {
         createInstance();
         return _instance;
      }
      
      public static function get service() : GSON
      {
         createInstance();
         return _instance;
      }
