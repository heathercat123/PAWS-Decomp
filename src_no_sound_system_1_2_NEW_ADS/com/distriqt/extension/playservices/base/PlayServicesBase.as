package com.distriqt.extension.playservices.base
{
   ...
   public final class PlayServicesBase extends EventDispatcher
   {
      ...
      public static const VERSION:String = "18.1.1";
      ...
      private static const ERROR_SINGLETON:String = "The singleton has already been created. Use PlayServicesBase.service to access the functionality";
      ...
      public function PlayServicesBase()
      {
         ...
         throw new Error("The singleton has already been created. Use PlayServicesBase.service to access the functionality");
      }
