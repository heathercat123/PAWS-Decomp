package entities.enemies
{
   ...
   import sprites.enemies.SeaJumperFishEnemySprite;
   ...
   public class SeaJumperFishEnemy extends Enemy
   {
      ...
      public function SeaJumperFishEnemy(_level:Level, _xPos:Number, _yPos:Number, _direction:int, _ai_index:int)
      {
         ...
         speed = 0.8;
         MAX_Y_VEL = 0.5;
         sprite = new SeaJumperFishEnemySprite();
      ...
      override public function update() : void
      {
         ...
         if(stateMachine.currentState == "IS_WALKING_STATE")
         {
            ...
            else
            {
               ...
               {
                  xVel = MAX_X_VEL;
                  if(xPos - 16 >= level.camera.xPos + Utils.WIDTH)
                  {
                     dead = true;
                  }
               }
