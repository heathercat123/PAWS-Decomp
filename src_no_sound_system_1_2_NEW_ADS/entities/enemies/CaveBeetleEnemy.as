package entities.enemies
{
   ...
   import sprites.enemies.CaveBeetleEnemySprite;
   ...
   public class CaveBeetleEnemy extends Enemy
   {
      ...
      public function CaveBeetleEnemy(_level:Level, _xPos:Number, _yPos:Number, _flipped_hor:int, _flipped_ver:int, __rotation:int, _ai_index:int)
      {
         ...
         sprite = new CaveBeetleEnemySprite();
      ...
      override public function shake() : void
      {
         if(isInsideScreen())
         {
            stateMachine.performAction("SHAKE_ACTION");
         }
      }
