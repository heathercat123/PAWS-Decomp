package entities.enemies
{
   ...
   public class SandWormEnemy extends Enemy
   {
      ...
      public function SandWormEnemy(_level:Level, _xPos:Number, _yPos:Number, _direction:int, _ai:int, _param_2:int)
      {
         ...
         sprite = new SandWormEnemySprite();
