package entities.enemies
{
   ...
   import sprites.enemies.TankSoldierEnemySprite;
   import sprites.particles.WorriedParticleSprite;
   
   public class TankSoldierEnemy extends TinEnemy
   {
      ...
      public function TankSoldierEnemy(_level:Level, _xPos:Number, _yPos:Number, _direction:int, _ai:int)
      {
         ...
         sprite = new TankSoldierEnemySprite();
